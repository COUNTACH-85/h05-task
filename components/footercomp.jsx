...
const FooterComp = () => {
  return (
    <footer className="bg-[#F0F0F0] pt-10 pb-0 px-4 md:px-0">
      <div className="max-w-6xl mx-auto w-full">
        <div className="bg-black rounded-2xl p-6 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-10 -mt-16 md:-mt-20 mb-8 md:mb-14 shadow-lg">
          <div className="text-white text-2xl md:text-3xl font-bold leading-tight text-center md:text-left">
          ...
          <div className="flex flex-col gap-3 w-full md:w-[400px]">
            ...
            <button className="bg-white text-black rounded-full px-4 py-2 font-semibold text-sm hover:bg-gray-200 transition">
      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="flex flex-col items-start md:w-[220px]">
            <div className="font-black text-2xl mb-2 tracking-tight">SHOP.CO</div>
